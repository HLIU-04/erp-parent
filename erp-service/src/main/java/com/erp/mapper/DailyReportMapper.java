...
public interface DailyReportMapper {
     ...
     * @return
     */
    List<DeptTurnoverStatVO> selectDeptTurnoverByDateRange(LocalDate startDate, LocalDate endDate);
     ...
     * @return
     */
    List<DailyReportItemExportVO> selectExportData(LocalDate deliveryDate);
}
